...
import 'package:ataa_charity_system/view/screens/home_screen/home_screen.dart';
...
import '../volunter_campign_screen/volunter_campign_screen.dart';
        ...
        children: [
          Padding(
            padding: const EdgeInsets.symmetric(
                vertical: 12, horizontal: defultPadding / 2),
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => DonationCampiganScreen()),
                );
              },
              child: Column(
                children: [
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => VolunterCampignScreen()),
                );
              },
              child: Column(
                children: [
          ...
          Padding(
            padding: const EdgeInsets.symmetric(
                vertical: 7, horizontal: defultPadding / 2),
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
